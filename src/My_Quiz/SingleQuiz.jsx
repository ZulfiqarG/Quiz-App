...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Box, Grid, FormControlLabel, Button, TextField, Typography, FormControl, Select, MenuItem, Alert, AlertTitle } from '@mui/material';
...
My Quizes</Typography>
<Button variant="contained" type="submit" style={{ justifyContent: "center" }} startIcon={<CreateNewFolderIcon />} onClick={handleNavigate}>
                    Create New Quiz
                  </Button>        
</div>
      ...
      <Table aria-label="simple table">             
        ...
        {quizData.map((quiz, index) => ( 
            <TableRow key={quiz.ID}>
              ...
              <TableCell align="right">{quiz.groupName}</TableCell>
              <TableCell align="right">
              <FormControlLabel
              label={activeQuizIds.includes(quiz.ID) ? 'Active' : 'Inactive'}
              control={
                <IOSSwitch                
                  sx={{ m: 1 }}                                    
                  checked={activeQuizIds.includes(quiz.ID)}
                  onChange={() => handleChangeActive(quiz.ID)}  
                                  
                />
              }
    />
              </TableCell>
              <TableCell align="right">{quiz.CreatedOn}</TableCell>
              <TableCell align="right">
                <Button onClick={() => showUpdateForm(quiz.ID)}><Edit /></Button>                
                <Button onClick={() => showViewForm(quiz.ID)}><Visibility /></Button>              
  ...
  <div>
    ...
    <Grid align='center'>           
        ...
        >          
          ...
          <div className="headerstyle">
        <Typography variant="h5"><Button variant="contained" onClick={updateLocalStorage} startIcon={<UpdateIcon />}> Update Quiz</Button></Typography>
        <Typography variant="h5" align="right"><Button variant="contained" onClick={handleBack} startIcon={<ArrowLeftIcon />}>Back</Button></Typography>
      </div>  
    ...
    <Grid align='center'>           
        ...
        <TextField type="text" disabled
         ...
         />               
          ...
          <hr className="hrStyle"></hr>    
          <Button variant="contained" onClick={handleBack} startIcon={<ArrowLeftIcon />}> Back</Button>
              </Paper>
            </Grid>            
          </Grid>
        </Box>
